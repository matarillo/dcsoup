...
namespace Supremes.Helper
{
    ...
    {
        internal static IDictionary<string, Utf32> GetBaseProperties()
        {
            return new Dictionary<string, Utf32>
            {
                { "AElig", 0x000C6 },
                { "AMP", 0x00026 },
                { "Aacute", 0x000C1 },
        ...
        internal static IDictionary<string, Utf32> GetFullProperties()
        {
            return new Dictionary<string, Utf32>
            {
                { "AElig", 0x000C6 },
